  ...
  <?php
        ...
        ?>
          ...
          <tr>
            ...
            <td><a href="edit_ticket.php?ticket_id=<?=$row["ticket_id"]?>" class="btn btn-warning mb-4">Edit</a></td>  
            <td><a href="delete_ticket.php?ticket_id=<?=$row["ticket_id"]?>" class="btn btn-danger" mb-4 onclick="Del(this.href);return false;">Delete</a></td>  
        </tr>
        <?php
