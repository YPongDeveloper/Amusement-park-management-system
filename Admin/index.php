                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link"
                                    href="employee/table_employee.php">employee</a>
                                <a class="nav-link"
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <a href="employee/fr_employee.php" class="btn btn-success mb-2 float-end">Add</a>
                        <div class="card-body  ">
                                ...
                                <tbody>
                                    ...
                                    { //เริ่มการทำงานเเสดงผลคอลัมน์
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="employee/edit_employee.php?emp_id=<?= $row["emp_id"] ?>"class="btn btn-warning ">Edit</a></td>

                                            <td><a href="employee/delete_employee.php?emp_id=<?= $row["emp_id"] ?>"class="btn btn-danger" mb-4 onclick="Del(this.href);return false;">Delete</a></td>
                                        </tr>
